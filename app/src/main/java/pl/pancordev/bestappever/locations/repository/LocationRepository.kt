...
class LocationRepository {
    ...
    fun getLocationDescriptions(): Observable<Array<LocationDescription>> {
//        val fromServer = api.getAllCities().map { city ->
//            LocationDescription(city.id.toInt(), city.city, city.url, city.description)
//        }
        val fromDatabase = arrayOf(
        ...
        return BehaviorSubject.fromArray(fromDatabase)
    }
}